...
class SignUpComponent1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      errors: {
      ...
      <div className="container-fluid">
        ...
        <Row className="sign-up text-center">
          ...
          <Col className="col-12 right">
           ...
           <Row> 
             <Col className="col-5 left"><Link to="/sign-up"><i className="fa fa-long-arrow-left arrow-icon fa-3x" aria-hidden="true"></i></Link></Col>
             <Col className="col-7 right"><h1 className='text-left text-dark font-weight-bold'>Contact Details.</h1></Col>
           </Row>
            ...
            <div className="form">
              <div className="form-border row"> 
                ...
                <Col className='footer'><span className="text-dark">Already have an account?</span> <Link to='/sign-in' onClick={this.handleClick} style={{ color: '#41b3c4', textDecoration:'underline'}}>Click here to login</Link></Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(SignUpComponent1));
